package com.danilo.santos.my.app.gpslocation;
...
public class MainActivity extends AppCompatActivity {
    ...
    private Button btnObterCoordenadas;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btnObterCoordenadas = findViewById(R.id.btn_obter_coordenadas);
        tvLatitude = findViewById(R.id.tv_latitude);
        tvLongitude = findViewById(R.id.tv_longitude);

        fusedLocationProviderClient = LocationServices.getFusedLocationProviderClient(MainActivity.this);

        btnObterCoordenadas.setOnClickListener(new View.OnClickListener() {
            @Override
    ...
    public void onRequestPermissionsResult(int requestCode, @NonNull String[] permissions, @NonNull int[] grantResults) {
        if(requestCode == 100  && grantResults.length > 0 && (grantResults[0] + grantResults [1] == PackageManager.PERMISSION_GRANTED)) {
            ...
            Toast.makeText(getApplicationContext(), "Permissões negadas!", Toast.LENGTH_SHORT).show();
        }
    }
